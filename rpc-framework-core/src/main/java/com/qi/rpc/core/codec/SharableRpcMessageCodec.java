...
import com.qi.rpc.core.serialization.Serialization;
import com.qi.rpc.core.serialization.SerializationFactory;
...
/**
 * 可共享的 Rpc 消息编码解码器，使用此编解码器必须配合 {@link RpcFrameDecoder} 进行使用，
